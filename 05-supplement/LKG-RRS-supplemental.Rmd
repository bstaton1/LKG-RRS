...
To do this, we disaggregated the "total juvenile" metric into its components, and replicated the analyses for question #1 (i.e., fit hurdle models with covariates for sex, origin, arrival date, length, year, and interactions; AIC~c~ model selection; bootstrap RRS ratios from best model; determine how frequently CIs of RRS ratio overlap 1) separately for parr and smolt progeny per spawner.
