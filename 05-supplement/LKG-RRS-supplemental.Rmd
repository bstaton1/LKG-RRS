...
### **Figure S3a.** Juvenile Grand-Progeny
...
### **Figure S3b.** Adult Grand-Progeny
...
# Are Parr and Smolt Juveniles Produced at Equal Rates by NOR and HOR Spawners?
...
However, given that our results indicated that NOR spawners have higher juvenile reproductive success than HOR fish, this finding that HOR spawners may tend to produce a higher proportion of parr juveniles than NOR spawners actually suggests that, if anything, our results would be an underestimate of how many times more productive NOR spawners are than HOR spawners to the juvenile stage.

```{r validate-betabinomial, eval = FALSE}
# this is a verification that the beta binomial regression implemented by glmmTMB
# is as I understand it to be.
